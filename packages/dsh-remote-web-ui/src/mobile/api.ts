...
import type { WorkspaceView } from '../mobile-contract.ts'
import type { SessionSummary, SessionModels, SessionProjectionsBlock } from '../mobile-contract.ts'
...
export interface HistoryPage {
  events: import('../mobile-contract.ts').HistoryEntry[]
  hasMore: boolean
  /**
