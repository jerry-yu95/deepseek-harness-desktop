...
export const zh = {
  ...
  'settings.enabledHint': '关闭后移除侧边栏入口、撤销已配对设备并停用手机端访问。',
...
export const en = {
  ...
  'settings.enabledHint': 'When off, removes the sidebar entry, revokes paired devices and disables phone access.',
