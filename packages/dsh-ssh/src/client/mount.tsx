...
const SIBLING_PANEL_ATTRS: ReadonlyArray<string> = ['data-dsh-extension-active', 'data-dsh-taskboard-active']
const SIBLING_ENTRY_SELECTOR = '[data-dsh-extension-entry], [data-dsh-taskboard-entry]'
...
export function mountPanel(controller: PanelController, api: SshApi): () => void {
  ...
  const applyActive = (): void => {
    if (controller.getSnapshot().panelOpen) {
      ...
      // column immediately, and clear their stale entry highlights.
