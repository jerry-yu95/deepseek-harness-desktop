window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var ths_module_css_default = {
			"aionPreviewIn": "eXZ-vq_aionPreviewIn",
			"thsStatusbar": "eXZ-vq_thsStatusbar",
			"thsStatusbarCell": "eXZ-vq_thsStatusbarCell",
			"thsStatusbarSpacer": "eXZ-vq_thsStatusbarSpacer",
			"thsTitlebar": "eXZ-vq_thsTitlebar",
			"thsTitlebarBtn": "eXZ-vq_thsTitlebarBtn",
			"thsTitlebarIcon": "eXZ-vq_thsTitlebarIcon",
			"thsTitlebarTicker": "eXZ-vq_thsTitlebarTicker",
			"thsTitlebarTickerChg": "eXZ-vq_thsTitlebarTickerChg",
			"thsTitlebarTickerVal": "eXZ-vq_thsTitlebarTickerVal",
			"thsTitlebarTitle": "eXZ-vq_thsTitlebarTitle"
		};
		//#endregion
