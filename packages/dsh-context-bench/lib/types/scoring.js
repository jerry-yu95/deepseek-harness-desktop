import { containsExact, normalizeForMatch } from "./oracle.js";
...
function weightedRecall(fixture, categories, text) {
...
export function scoreCheckpoint(fixture, checkpoint, retainedTail = "") {
