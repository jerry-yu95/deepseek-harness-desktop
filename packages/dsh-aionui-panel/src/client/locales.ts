...
const zh = {
  ...
  'explorer.menu.addConversation': '添加到对话',
  'explorer.menu.addFallback': '未找到输入框，路径已复制，可直接粘贴到对话。',
  'explorer.menu.reveal': '在本地文件中显示',
  'explorer.menu.newFile': '新建文件',
  'explorer.menu.newFolder': '新建文件夹',
  'explorer.menu.copyPath': '复制完整路径',
  'explorer.menu.copyRelativePath': '复制相对路径',
  'explorer.menu.rename': '重命名',
  'explorer.menu.delete': '删除',
  'explorer.menu.fileName': '输入新文件名',
  'explorer.menu.folderName': '输入新文件夹名',
  'explorer.menu.renamePrompt': '输入新名称',
  'explorer.menu.deleteConfirm': '确定删除“{name}”吗？此操作不可恢复。',
...
const en: Record<keyof typeof zh, string> = {
  ...
  'explorer.menu.addConversation': 'Add to conversation',
  'explorer.menu.addFallback': 'The composer was not found. The path was copied so you can paste it.',
  ...
  'explorer.menu.fileName': 'New file name',
  'explorer.menu.folderName': 'New folder name',
  'explorer.menu.renamePrompt': 'New name',
  'explorer.menu.deleteConfirm': 'Delete “{name}”? This cannot be undone.',
