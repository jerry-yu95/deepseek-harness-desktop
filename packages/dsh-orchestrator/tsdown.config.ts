...
export default clientBundle(
  ...
  ['src/index.ts', 'src/core.ts', 'src/adaptive.ts', 'src/orchestration.ts', 'src/model-health.ts', 'src/observability.ts', 'src/context-quality.ts', 'src/context-quality-probe.ts', 'src/wire.ts'],
