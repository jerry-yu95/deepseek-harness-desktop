...
const SIBLING_PANEL_ATTRS: ReadonlyArray<string> = ['data-dsh-ssh-active', 'data-dsh-extension-active']
const SIBLING_ENTRY_SELECTOR = '[data-dsh-ssh-entry], [data-dsh-extension-entry]'
