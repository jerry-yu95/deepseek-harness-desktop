...
| 系统 | 文件 |
| --- | --- |
| Windows 10/11 x64 | `Harness-Design-Desktop-Setup-<版本>-x64.exe` |
| Intel Mac | `Harness-Design-Desktop-<版本>-x64.dmg` |
| Apple 芯片 Mac（M1/M2/M3/M4 等） | `Harness-Design-Desktop-<版本>-arm64.dmg` |
...
1. 打开 DMG，把应用拖入“应用程序”。
2. 在 Finder 的“应用程序”中找到 Harness Design Desktop。
